...
import { BotIcon, CodeIcon, Loader2Icon, UserIcon, Mountain } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        {role === "user" && <Markdown text={text} className="text-sm" />}
...
const MessagePart = ({
  ...
  if (data.type === "text") return <Markdown text={data.data} className="text-sm" />;
