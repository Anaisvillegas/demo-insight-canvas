...
const SignUpForm = () => {
  ...
  return (
    <main className="flex flex-col gap-6 items-center w-full h-screen pt-8 px-4 bg-[#f9fafb]">
        ...
        <CardContent className="grid gap-4">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-[#1a56db] hover:bg-[#1e429f] text-white">
